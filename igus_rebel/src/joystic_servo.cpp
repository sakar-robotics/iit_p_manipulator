...
int main(int argc, char *argv[])
{
    ...
    auto node = std::make_shared<igus_moveit_servo::JoyToServo>(rclcpp::NodeOptions());
    rclcpp::spin(node);
    rclcpp::shutdown();
    return 0;
}
...
// RCLCPP_COMPONENTS_REGISTER_NODE(igus_moveit_servo::JoyToServo)